...
> [!NOTE]
> You should start by swapping all of "postgresql-simple", "postgresql-libpq", and "postgresql-query" in your cabal files by "hpgsql-simple-compat". That is as API-compatible with the three libraries above as I could make it.
